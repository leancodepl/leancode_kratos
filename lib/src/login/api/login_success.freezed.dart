...
mixin _$SuccessLoginResponse {
  ...
  /// Serializes this SuccessLoginResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of SuccessLoginResponse
...
class _$SuccessLoginResponseImpl implements _SuccessLoginResponse {
  const _$SuccessLoginResponseImpl(
...
abstract class _SuccessLoginResponse implements SuccessLoginResponse {
  const factory _SuccessLoginResponse(
      ...
      required final Session session}) = _$SuccessLoginResponseImpl;
