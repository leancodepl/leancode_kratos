...
Session _$SessionFromJson(Map<String, dynamic> json) => Session(
  ...
  authenticatorAssuranceLevel: json['authenticator_assurance_level'] as String,
...
Map<String, dynamic> _$IdentityToJson(Identity instance) => <String, dynamic>{
  ...
  'verifiable_addresses': instance.verifiableAddresses
      .map((e) => e.toJson())
      .toList(),
  'recovery_addresses': instance.recoveryAddresses
      .map((e) => e.toJson())
      .toList(),
